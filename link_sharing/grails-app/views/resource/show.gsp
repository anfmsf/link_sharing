	...
	<body>
		...
		<div id="show-resource" class="content scaffold-show" role="main">
			...
			<ol class="property-list resource">
				...
				<li class="fieldcontain">
					<span id="creator-label" class="property-label"><g:message code="resource.creator.label" default="Creator" /></span>
					
						<span class="property-value" aria-labelledby="creator-label"><g:link controller="user" action="show" id="${resourceInstance?.creator?.id}">${resourceInstance?.creator?.encodeAsHTML()}</g:link></span>
